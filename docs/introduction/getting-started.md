...
You can download Clash core binaries here: [https://github.com/laof/collide/releases](https://github.com/laof/collide/releases)
...
For other build targets, check out the [Makefile](https://github.com/laof/collide/blob/master/Makefile).
