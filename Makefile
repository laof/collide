...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/laof/collide/constant.Version=$(VERSION)" \
		-X "github.com/laof/collide/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
